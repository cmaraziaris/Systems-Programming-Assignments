...
> Makefile
> README.txt
> bash_script_sample_files/ : Αρχεία χωρών/ασθενειών για ορίσματα στο bash script (εντελώς προαιρετική η χρήση τους, μπορείτε να δώσετε οποιαδήποτε αρχεία χωρών/ασθενειών).
